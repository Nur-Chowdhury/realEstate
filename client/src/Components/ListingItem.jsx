...
export default function ListingItem({ listing }) {
  return (
    <div className='bg-white dark:bg-black shadow-md dark:shadow-gray-700 hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[330px]'>
      <Link to={`/listing/${listing._id}`}>
        ...
        <div className='p-3 flex flex-col gap-2 w-full'>
          ...
          <div className='text-slate-700 dark:text-slate-300 flex gap-4'>
